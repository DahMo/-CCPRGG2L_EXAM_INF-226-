...
public class Regex {
    public static void main(String[] args) {
        ...
        // Provide the pattern
        pattern = Pattern.compile("^\\w[^RYSrys]{4,5}");
        ...
        pattern = Pattern.compile("\\w{15,}@ymail.com");
        ...
        // Provide regex pattern
        pattern = Pattern.compile("(^[https://]*)+\\w{3,}+(\\.com)");
        ...
        // Provide regex pattern
        pattern = Pattern.compile("\\w+((.pptx)|(.txt)|(.xlsx)|(.docx))");
